...
best_fit_phase = chi_dict[min(chi_value_list)]
# print best_fit_period
# print period_time[best_fit_period]
print best_fit_phase
...
sub1.plot(time, f.box(period, np.arange(0, best_fit_phase), depth, width, length), color="blue", marker=",")
...
sub2.plot(chi_squared_list, color = 'black', marker = '.', markersize = 10)
